import { GroupRole, IModule, WKApp } from "@hxx/base"
import { Channel, ChannelInfo, ChannelTypeGroup, ChannelTypePerson, Conversation, WKSDK, Message, Subscriber, ConversationExtra, Reminder } from "hxximjssdk";
import { MessageTask } from "hxximjssdk";
